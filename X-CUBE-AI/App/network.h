...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "tflite_learn_779780_11"
...
#define AI_NETWORK_OUT_1_HEIGHT      (12)
#define AI_NETWORK_OUT_1_WIDTH       (12)
#define AI_NETWORK_OUT_1_CHANNEL     (3)
#define AI_NETWORK_OUT_1_SIZE        (432)
#define AI_NETWORK_OUT_1_SIZE_BYTES  (432)
